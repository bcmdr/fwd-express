...
//   use: ExtractTextPlugin.extract(['css-loader?sourceMap', postcssSass, 'sass-loader?sourceMap'])
// };

// Setup postcss for use with tailwind
const css = {
  test: /\.css$/,
...
const config = {
  entry: {
    ...
    App: './public/javascripts/fwd-app.js'
  },
